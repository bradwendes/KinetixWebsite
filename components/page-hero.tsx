...
const heroImages: Record<string, { src: string; alt: string; position?: string }> = {
  ...
  'Kinetix in Action': { src: '/images/kinetix-in-action-hero.jpg', alt: 'Team Kinetix acrobat performing a backflip against a dramatic evening sky', position: 'center 25%' },
